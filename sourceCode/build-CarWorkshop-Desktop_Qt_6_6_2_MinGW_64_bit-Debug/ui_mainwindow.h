...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(785, 517);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(130, 70, 451, 20));
        widget = new QWidget(centralwidget);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(100, 280, 541, 111));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnquery->setText(QCoreApplication::translate("MainWindow", "I'm Boss", nullptr));
        btninsert->setText(QCoreApplication::translate("MainWindow", "I'm Employee", nullptr));
    } // retranslateUi
